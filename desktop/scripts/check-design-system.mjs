...
const allowedUndefinedVars = new Set([
  ...
  '--widget-text-subtle',
  '--widget-text-muted',
  '--knowledge-block-callout-bg',
  '--knowledge-block-code-bg',
  '--knowledge-block-diagram-bg',
  '--knowledge-block-inline-code-bg',
  '--knowledge-block-quote-bg',
  '--knowledge-block-table-bg',
  '--knowledge-block-table-cell-bg',
  '--knowledge-canvas-element-bg',
  '--knowledge-md-block-bg',
  '--knowledge-md-callout-bg',
  '--knowledge-md-code-bg',
  '--knowledge-md-diagram-bg',
  '--knowledge-md-inline-code-bg',
  '--knowledge-md-quote-bg',
  '--knowledge-md-table-bg',
  '--knowledge-selection-bg',
]);
