...
> **Execution audit (2026-07-23):** Checked items have implementation and fresh verification evidence. Unchecked items remain planned work, including the deliberate red-phase commands not captured during inline execution, full CLI-to-host DevChannel attach, real GitHub/Marketplace mutation, and fixture production-build inspection.
...
- [x] **Step 1: Write failing manifest compatibility tests.**
...
- [x] **Step 3: Add canonical public contract types.**
...
- [x] **Step 4: Implement resolver and permission checks.**
...
- [x] **Step 5: Run tests, typecheck the affected package, and commit.**
...
- [x] **Step 3: Add the package and token exports.**
...
- [x] **Step 4: Implement the first Custom Elements.**
...
- [x] **Step 5: Add framework adapters and theme registration.**
...
- [x] **Step 6: Run UI package tests and build.**
...
- [x] **Step 7: Commit the UI package.**
...
- [x] **Step 1: Write failing SDK invoke and theme tests.**
...
- [x] **Step 3: Make `packages/plugin-sdk` the public runtime facade.**
...
- [x] **Step 4: Add theme runtime methods.**
...
- [x] **Step 5: Re-export the SDK from the desktop bridge.**
...
- [x] **Step 6: Run SDK and desktop tests.**
...
- [x] **Step 7: Commit the SDK bridge.**
...
- [x] **Step 1: Write fixture build tests.**
...
- [x] **Step 3: Implement `defineGuYanPluginConfig`.**
...
- [x] **Step 4: Implement manifest copy and output validation.**
...
- [x] **Step 5: Add Vue and React templates.**
...
- [x] **Step 6: Run both fixture builds and typecheck.**
...
- [x] **Step 7: Commit the Vite preset and templates.**
...
- [x] **Step 1: Write failing DevSession validation tests.**
...
- [x] **Step 3: Implement the in-memory DevSession manager.**
...
- [x] **Step 5: Preserve runtime security for dev URLs.**
...
- [x] **Step 6: Run security tests and commit.**
...
- [x] **Step 3: Add DevSession-aware URL selection.**
...
- [x] **Step 4: Add theme IPC and event forwarding.**
...
- [x] **Step 6: Run router, theme, and desktop checks.**
...
- [x] **Step 7: Commit runtime mounting and theme synchronization.**
...
- [x] **Step 3: Implement `create`, `validate`, and `build`.**
...
- [x] **Step 6: Run CLI tests, typecheck, and a clean package build.**
...
- [x] **Step 7: Commit the CLI and dev attach flow.**
...
- [x] **Step 1: Write publish dry-run tests.**
...
- [x] **Step 6: Run publication checks.**
...
- [x] **Step 7: Commit publication support.**
...
- [x] **Step 1: Write pure UI state tests.**
...
- [x] **Step 6: Commit host controls and fixtures.**
...
- [x] **Step 3: Review the final diff for boundaries.**
...
- [x] **Step 4: Commit documentation and final verification updates.**
