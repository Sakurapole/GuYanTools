...
const checks = [
  ...
  ['desktop/src/windows/main/pages/AI/AiChatPage.vue', ['AiConversationList', 'AiMessageList', 'AiCanvasPanel', 'AiAgentReservedPanel', 'aiPageMode']],
  ...
  ['desktop/src/windows/main/pages/AI/components/AiConversationList.vue', ['searchQuery', 'rename', 'pin']],
